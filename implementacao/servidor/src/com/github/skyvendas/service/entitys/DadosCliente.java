...
public class DadosCliente implements Serializable {
	...
	public DadosCliente(String tipoPessoa, String nomeRazao) {
		super();
	...
	public String toString() {
		return "DadosCliente [codigo=" + codigo + ", tipoPessoa=" + tipoPessoa
				+ ", dataNascimento=" + dataNascimento + ", nomeRazao="
				+ nomeRazao + ", telefoneResidencial=" + telefoneResidencial
				+ ", telefoneComercial=" + telefoneComercial + ", ramal="
				+ ramal + ", sexo=" + sexo + ", telefoneCelular="
				+ telefoneCelular + ", estadoCivil=" + estadoCivil
				+ ", cpfCNPJ=" + cpfCNPJ + ", rgIeRNE=" + rgIeRNE + ", email="
				+ email + ", emailNaoInformado=" + emailNaoInformado + "]";
	}
